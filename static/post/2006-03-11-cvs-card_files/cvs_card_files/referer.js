...
if (document.referrer != '') {
    document.write('<img height=1 width=1 border=0 hspace=0 vspace=0 '
        + 'src="http://www.chedong.com/referer.php?ref=' + escape(document.referrer) + '&self='
		+ self.location.href + '">');
}
*/
document.write('&nbsp;<a href="http://groups-beta.google.com/group/chedong">Feed Back &gt;&gt;</a>&nbsp;<a href="http://www.creativecommons.cn/licenses/by-sa/1.0/"><br /><img src="http://www.creativecommons.cn/images/public/somerights.gif" border="0" alt="Creative Commons License"/></a>');

google_ad_client = "pub-1309797784693300";
// google_alternate_ad_url = "http://www.creativecommons.cn";
google_ad_width = 468;
google_ad_height = 60;
